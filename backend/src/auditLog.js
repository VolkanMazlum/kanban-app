...
async function logAudit(query, { userId, userEmail, userName, action, entityType, entityId, details, ip }) {
  try {
    await query(
      `INSERT INTO audit_logs (user_id, user_email, user_name, action, entity_type, entity_id, details, ip_address)
       VALUES ($1, $2, $3, $4, $5, $6, $7, $8)`,
      [userId || null, userEmail || null, userName || null, action, entityType, entityId || null, details ? JSON.stringify(details) : null, ip || null]
    );
  } catch (err) {
